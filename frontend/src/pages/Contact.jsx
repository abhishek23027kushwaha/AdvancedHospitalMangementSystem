...
const Contact = () => {
  ...
  const [contactInfo, setContactInfo] = useState({
    ...
    emergencyNumber: "8299431275",
    address: "Gomtinagar, Lucknow, Uttar Pradesh",
  });
      ...
      try {
        ...
        if (data.success && data.contact) {
          setContactInfo({
            ...
            emergencyNumber: data.contact.emergencyNumber || "8299431275",
            address: data.contact.address || "Gomtinagar, Lucknow, Uttar Pradesh",
          });
        }
      } catch (err) {
...
${form.message}`;
    ...
    // Remove all non-numeric characters from the WhatsApp number
    const waNumber = contactInfo.emergencyNumber.replace(/\D/g, '');
    window.open(`https://wa.me/91${waNumber}?text=${encoded}`, "_blank");
  };
      ...
      <section className="flex-1 py-12 px-4 bg-emerald-50/30">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <a href={`tel:${contactInfo.emergencyNumber}`} className="hover:text-emerald-600 transition-colors">{contactInfo.emergencyNumber}</a>
                </div>
                <div className="flex items-center gap-3 text-gray-600">
                  <svg className="w-4 h-4 text-emerald-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            ...
            {/* Quick WhatsApp Card */}
            <a
              href={`https://wa.me/91${contactInfo.emergencyNumber.replace(/\D/g, '')}`}
              target="_blank"
              rel="noopener noreferrer"
