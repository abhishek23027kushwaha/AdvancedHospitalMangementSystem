...
import { Eye, EyeOff, Mail, Lock, Stethoscope, CheckCircle2 } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f1f4f9] flex items-center justify-center p-3 sm:p-6 font-sans">
      ...
      >
        {/* ── LEFT PANEL: Royal Blue with Medical Shield Plus Artwork ── */}
        <div className="w-full md:w-[46%] bg-[#2f5af6] p-8 lg:p-10 text-white flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="z-10 mt-2">
            ...
            <p className="text-white/80 text-xs lg:text-sm leading-relaxed mb-5 font-normal max-w-sm">
              Connect with certified doctors, schedule instant appointments, and manage your health records in one secure portal.
            </p>
        ...
        <div className="w-full md:w-[54%] p-8 sm:p-12 lg:p-14 flex flex-col justify-center bg-white">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-slate-500 text-xs sm:text-sm mt-2 leading-relaxed">
              Login to access your patient dashboard. View appointments, doctor consultations, and medical history.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-xs pt-1 pb-1">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  toast('Password reset email instructions sent if registered.');
                }}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              onClick={() => toast('Google Sign-In is enabled for Google OAuth')}
          ...
          {/* Bottom Footer & Doctor Link */}
          <div className="mt-8 pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-500">
            <div>
            ...
            <Link to="/doctor/login" className="text-[#2f5af6] hover:underline font-medium flex items-center gap-1">
              <Stethoscope size={13} />
              Doctor Portal
            </Link>
          </div>
